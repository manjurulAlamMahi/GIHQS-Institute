        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Result Create</h4>
                    <a href="{{ route('admin.pathway-results.index') }}" class="btn btn-sm btn-primary">Back</a>
                </div>

                <form action="{{ route('admin.pathway-results.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    ...
                                    <input type="text" name="badges" id="badges" class="form-control @error('badges') is-invalid @enderror" placeholder="e.g. Apply, Accreditation, Institutional" value="{{ old('badges') }}">
                            ...
                            <div class="col-xxl-12 col-md-12">
                                ...
                                <textarea name="info_box_text" id="info_box_text" class="form-control @error('info_box_text') is-invalid @enderror" rows="2" placeholder="e.g. This route is appropriate when...">{{ old('info_box_text') }}</textarea>
                                @error('info_box_text')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <input type="text" name="primary_button_text" id="primary_button_text" class="form-control @error('primary_button_text') is-invalid @enderror" placeholder="e.g. Apply for Accreditation" value="{{ old('primary_button_text', 'Apply for Accreditation') }}" required>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <input type="text" name="primary_button_url" id="primary_button_url" class="form-control @error('primary_button_url') is-invalid @enderror" placeholder="e.g. /accreditation/apply" value="{{ old('primary_button_url') }}">
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <input type="text" name="secondary_button_text" id="secondary_button_text" class="form-control @error('secondary_button_text') is-invalid @enderror" placeholder="e.g. View Accreditation" value="{{ old('secondary_button_text', 'View Accreditation') }}" required>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <input type="text" name="secondary_button_url" id="secondary_button_url" class="form-control @error('secondary_button_url') is-invalid @enderror" placeholder="e.g. /accreditation/overview" value="{{ old('secondary_button_url') }}">
