...
<head>
    ...
    <title>Advisory Payment Request</title>
</head>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -1px rgba(0,0,0,0.06); border: 1px solid #e5e7eb;">
        ...
        <tr>
            <td style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); padding: 40px 30px; text-align: center;">
                ...
                <p style="color: #bfdbfe; margin: 5px 0 0 0; font-size: 14px;">
                    Advisory Reference: {{ $advisoryRequest->reference_number }}
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 40px 30px;">
                ...
                <p style="font-size: 15px; color: #4b5563;">
                    Our advisory committee has reviewed your request for <strong>{{ $advisoryRequest->service_of_interest }}</strong> for <strong>{{ $advisoryRequest->organization_name }}</strong>.
                </p>
                <p style="font-size: 15px; color: #4b5563;">
                    Based on your requirements, the custom advisory fee has been set. Please complete your payment using the secure Stripe Checkout link below to proceed with your advisory consultation.
                </p>
                ...
                <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 20px; margin: 25px 0;">
                    <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 14px; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="padding: 8px 0; color: #0f172a; text-align: right; font-weight: 600;">{{ $advisoryRequest->organization_name }}</td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; color: #64748b; font-weight: 600;">Service Requested:</td>
                            <td style="padding: 8px 0; color: #0f172a; text-align: right;">{{ $advisoryRequest->service_of_interest }}</td>
                        </tr>
                        <tr style="border-top: 1px dashed #cbd5e1; border-bottom: 1px dashed #cbd5e1;">
                            ...
                            <td style="padding: 12px 0; color: #059669; font-size: 20px; font-weight: 800; text-align: right;">
                                ${{ number_format($amount, 2) }} {{ strtoupper($advisoryRequest->payment_currency ?? 'USD') }}
                            </td>
                        </tr>
                    </table>
        ...
        <tr>
            <td style="background-color: #f9fafb; padding: 30px; border-top: 1px solid #f3f4f6; text-align: center; border-radius: 0 0 12px 12px;">
                ...
                <p style="margin: 5px 0 0 0; font-size: 11px; color: #d1d5db;">This is an automated notification from GIHQS Advisory Services.</p>
            </td>
        </tr>
    </table>
</body>
