                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-xxl-12 col-md-12">
                                ...
                                <select class="form-select @error('page_position') is-invalid @enderror" name="page_position" id="page_position">
                                    ...
                                    <option value="reach_us" {{ old('page_position', $banner->page_position) == 'reach_us' ? 'selected' : '' }}>Reach Us</option>
                                    <option value="news" {{ old('page_position', $banner->page_position) == 'news' ? 'selected' : '' }}>News</option>
                                    <option value="events" {{ old('page_position', $banner->page_position) == 'events' ? 'selected' : '' }}>Events</option>
                                </select>
                                @error('page_position')
                            ...
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    ...
                                    <input type="file" name="image" id="image" class="form-control dropify" data-allowed-file-extensions="jpg jpeg png gif webp"
                                        @if ($banner->image) data-default-file="{{ asset($banner->image) }}" @endif>
                                    @error('image')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    ...
                                    <input type="text" name="banner_title" id="banner_title" class="form-control" placeholder="Enter Title" value="{{ old('banner_title', $banner->banner_title) }}">
                                    @error('banner_title')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xxl-12 col-md-12">
                                ...
                                <textarea name="banner_description" id="banner_description" class="form-control" rows="3">{{ old('banner_description', $banner->banner_description) }}</textarea>
