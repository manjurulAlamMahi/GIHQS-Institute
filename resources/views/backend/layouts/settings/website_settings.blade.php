        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Update Website Settings</h4>
                </div><!-- end card header -->
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <input type="email" name="support_email" id="support_email" class="form-control" placeholder="Enter support email address"
