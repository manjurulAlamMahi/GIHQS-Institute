...
class MailSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            if (!str_contains($envContent, 'MAIL_RECEIVE_ADDRESS=')) {
                $envContent = str_replace(
                    'MAIL_FROM_ADDRESS=',
                    'MAIL_RECEIVE_ADDRESS=""' . $lineBreak . 'MAIL_FROM_ADDRESS=',
                    $envContent
                );
            }
            ...
            $envContent = preg_replace([
                ...
                'MAIL_RECEIVE_ADDRESS=' . '"' . $request->mail_receive_address . '"' . $lineBreak,
            ], $envContent);
