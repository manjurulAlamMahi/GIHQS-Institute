            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Clone Package</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-10">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Clone Membership Package</h4>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name', $package->name . ' (Clone)') }}" placeholder="Enter package name">
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror"
                                    value="{{ old('title', $package->title) }}" placeholder="Enter package title">
                                @error('title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" min="0" max="100" name="discount_percentage" id="discount_percentage" class="form-control @error('discount_percentage') is-invalid @enderror"
                                    value="{{ old('discount_percentage', $package->discount_percentage) }}" placeholder="Enter discount percentage (e.g. 30.00)">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="validity_days" id="validity_days" class="form-control @error('validity_days') is-invalid @enderror"
                                    value="{{ old('validity_days', $package->validity_days) }}" placeholder="Enter validity days (e.g. 30)">
                                @error('validity_days')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" min="0" name="exam_attempt_limit" id="exam_attempt_limit" class="form-control @error('exam_attempt_limit') is-invalid @enderror"
                                    value="{{ old('exam_attempt_limit', $package->exam_attempt_limit) }}" placeholder="Enter maximum exam attempts (e.g. 3)">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="short_description" id="short_description" class="form-control @error('short_description') is-invalid @enderror"
                                    rows="3" placeholder="Enter short description">{{ old('short_description', $package->short_description) }}</textarea>
                                ...
                                @if ($package->features->count() > 0)
                                    @foreach ($package->features as $feature)
                                        <div data-repeater-item class="row mb-3 align-items-start p-3 border rounded bg-light">
                                            {{-- No hidden ID input here because we are creating a new cloned package with new features --}}
                                            <div class="col">
                                                <div class="row g-2">
                                                    <div class="col-md-8">
                                                ...
                                                <textarea name="note" class="form-control" rows="1"
                                                    placeholder="Enter note (optional)">{{ $feature->note }}</textarea>
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.repeater-features').repeater({
                show: function() {
                    $(this).slideDown();
                    // Clear fields inside the cloned item
