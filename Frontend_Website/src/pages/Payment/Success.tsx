  ...
  return (
    <main className="min-h-screen bg-primary flex items-center justify-center p-4">
      <div className="bg-white max-w-md w-full rounded-2xl shadow-sm p-8 text-center border border-neutral-100">
        <div className="mx-auto w-16 h-16 bg-[#d7f8e5] text-[#008a42] flex items-center justify-center rounded-full mb-6">
          <CheckCircle2 className="w-8 h-8" />
        </div>
        
        <h1 className="text-2xl font-semibold text-[#14392f] mb-2">Payment Successful!</h1>
        <p className="text-[#667085] mb-8 text-[15px] leading-relaxed">
          Thank you for your purchase. Your transaction was completed successfully and your {type} is now active.
        </p>
        ...
        <div className="flex flex-col gap-3">
          <Link
            ...
            className="inline-flex w-full h-12 items-center justify-center gap-2 rounded-xl bg-[#166046] px-4 font-semibold text-white hover:bg-[#123f32] transition-colors"
          >
            View Order History
          </Link>
          <Link
