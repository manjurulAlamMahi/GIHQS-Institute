        ...
        <div class="col-lg-10">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Create Catalogue Item</h4>
                ...
                <form action="{{ route('admin.catalogues.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror"
                                    value="{{ old('title') }}" placeholder="Enter catalogue item title">
                                @error('title')
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="short_title" id="short_title" class="form-control @error('short_title') is-invalid @enderror"
                                    value="{{ old('short_title') }}" placeholder="Enter short title (e.g. AIHQSP)">
                                @error('short_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('catalogue_type') is-invalid @enderror" name="catalogue_type" id="catalogue_type">
                                    <option value="paid" {{ old('catalogue_type', 'paid') == 'paid' ? 'selected' : '' }}>Paid</option>
                                    <option value="free" {{ old('catalogue_type') == 'free' ? 'selected' : '' }}>Free</option>
                                    <option value="members only" {{ old('catalogue_type') == 'members only' ? 'selected' : '' }}>Members Only</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('service_type') is-invalid @enderror" name="service_type" id="service_type">
                                    <option value="" {{ old('service_type') === null || old('service_type') === '' ? 'selected' : '' }}>Select Type</option>
                                    <option value="Certification" {{ old('service_type') == 'Certification' ? 'selected' : '' }}>Certification</option>
                                    <option value="Course" {{ old('service_type') == 'Course' ? 'selected' : '' }}>Course</option>
                                    <option value="Webinar" {{ old('service_type') == 'Webinar' ? 'selected' : '' }}>Webinar</option>
                                    <option value="Module" {{ old('service_type') == 'Module' ? 'selected' : '' }}>Module</option>
                                    <option value="Toolkit" {{ old('service_type') == 'Toolkit' ? 'selected' : '' }}>Toolkit</option>
                                    <option value="Workshop" {{ old('service_type') == 'Workshop' ? 'selected' : '' }}>Workshop</option>
                                </select>
                                @error('service_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" name="price_regular" id="price_regular" class="form-control @error('price_regular') is-invalid @enderror"
                                    value="{{ old('price_regular') }}" placeholder="Enter price">
                                @error('price_regular')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('is_discount_active') is-invalid @enderror" name="is_discount_active" id="is_discount_active">
                                    <option value="0" {{ old('is_discount_active') == '0' ? 'selected' : '' }}>No</option>
                                    <option value="1" {{ old('is_discount_active') == '1' ? 'selected' : '' }}>Yes</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" name="discount_value" id="discount_value" class="form-control @error('discount_value') is-invalid @enderror"
                                    value="{{ old('discount_value', '0.00') }}" placeholder="0.00">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" name="price_final" id="price_final" class="form-control @error('price_final') is-invalid @enderror"
                                    value="{{ old('price_final') }}" placeholder="Enter final price" readonly style="background-color: #e9ecef;">
                                @error('price_final')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                             ...
                             <div class="col-md-6">
                                 ...
                                 <input type="number" step="0.01" name="credit_earn" id="credit_earn" class="form-control @error('credit_earn') is-invalid @enderror"
                                     value="{{ old('credit_earn', '0.00') }}" placeholder="Enter credit earn value">
                                 @error('credit_earn')
                                     <div class="invalid-feedback">{{ $message }}</div>
                                 @enderror
                             </div>
                             ...
                             <div class="col-md-6 certification-only-field">
                                 ...
                                 <input type="number" step="0.01" name="ce_credit_total_required" id="ce_credit_total_required" class="form-control @error('ce_credit_total_required') is-invalid @enderror"
                                     value="{{ old('ce_credit_total_required', '0.00') }}" placeholder="Enter total CE credits required">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-6">
                                          ...
                                          <input type="number" name="validity_years" id="validity_years" class="form-control @error('validity_years') is-invalid @enderror"
                                              value="{{ old('validity_years', '1') }}" placeholder="Enter validity in years (e.g. 1)" min="1">
                                      ...
                                      <div class="col-md-12 mt-3">
                                          ...
                                          <textarea name="credential_statement" id="credential_statement" class="form-control @error('credential_statement') is-invalid @enderror"
                                              rows="3" placeholder="Enter certification credential statement">{{ old('credential_statement') }}</textarea>
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" type="checkbox" name="healthcare_quality_improvement" id="healthcare_quality_improvement" value="1" {{ old('healthcare_quality_improvement') ? 'checked' : '' }}>
                                            <label class="form-check-label fw-semibold" for="healthcare_quality_improvement">Healthcare Quality Improvement</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" type="checkbox" name="patient_safety_risk_management" id="patient_safety_risk_management" value="1" {{ old('patient_safety_risk_management') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="short_description" id="short_description" class="form-control @error('short_description') is-invalid @enderror"
                                    rows="3" placeholder="Enter a brief summary of the catalogue item">{{ old('short_description') }}</textarea>
                            ...
                            {{-- Module File --}}
                            {{-- <div class="col-md-6">
                                <label for="module_file" class="form-label">Module File (.html)</label>
                                <input type="file" name="module_file" id="module_file" class="form-control @error('module_file') is-invalid @enderror" accept=".html">
                                <small class="text-muted">Only .html files are accepted.</small>
                                @error('module_file')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-check form-check-inline mt-2">
                                            <input class="form-check-input" type="checkbox" name="is_feature" id="is_feature" value="1" {{ old('is_feature') ? 'checked' : '' }}>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa-solid fa-floppy-disk me-1"></i> Save Catalogue Item
                        </button>
                    </div>
                </form>
            </div>
