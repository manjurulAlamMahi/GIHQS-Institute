...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Strategic Advisory</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <form action="{{ route('admin.strategic-advisory.update', $strategicAdvisory->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card mb-4">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Strategic Advisory Panel Header</h4>
                    </div>
                    <div class="card-body">
                        <div class="row gy-4">
                            {{-- Title 1 --}}
                            <div class="col-md-4">
                                ...
                                <input type="text" name="title1" id="title1"
                                    ...
                                    value="{{ old('title1', $strategicAdvisory->title1) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="title2" id="title2"
                                    ...
                                    value="{{ old('title2', $strategicAdvisory->title2) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="tagline" id="tagline"
                                    ...
                                    value="{{ old('tagline', $strategicAdvisory->tagline) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="short_description" id="short_description"
                                    ...
                                    rows="3"
                                    placeholder="Enter Short Description">{{ old('short_description', $strategicAdvisory->short_description) }}</textarea>
                ...
                <div class="card mb-4">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Purpose of the Panel</h4>
                    </div>
                    <div class="card-body">
                        <div class="row gy-4">
                            {{-- Purpose Tagline --}}
                            <div class="col-md-6">
                                ...
                                <input type="text" name="purpose_tagline" id="purpose_tagline"
                                    ...
                                    value="{{ old('purpose_tagline', $strategicAdvisory->purpose_tagline) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="purpose_title" id="purpose_title"
                                    ...
                                    value="{{ old('purpose_title', $strategicAdvisory->purpose_title) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="purpose_short_description" id="purpose_short_description"
                                    ...
                                    rows="3"
                                    placeholder="Enter Purpose Short Description">{{ old('purpose_short_description', $strategicAdvisory->purpose_short_description) }}</textarea>
                ...
                {{-- Card 3: Advisory Features Section --}}
                <div class="card mb-4">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Advisory Focus & Features</h4>
                    </div>
                    <div class="card-body">
                        <div class="row gy-4 mb-3">
                            {{-- Advisory Title --}}
                            <div class="col-md-12">
                                <label for="advisory_title" class="form-label">Advisory Title</label>
                                <input type="text" name="advisory_title" id="advisory_title"
                                    class="form-control @error('advisory_title') is-invalid @enderror"
                                    value="{{ old('advisory_title', $strategicAdvisory->advisory_title) }}"
                                    placeholder="Enter Advisory Title">
                                @error('advisory_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="border-top pt-3">
                            <h5 class="card-title mb-3">Advisory Features</h5>

                            <div class="repeater-features">
                                <div data-repeater-list="features">
                                    @if ($strategicAdvisory->features->count() > 0)
                                        @foreach ($strategicAdvisory->features as $feature)
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="panel_title" id="panel_title"
                                    ...
                                    value="{{ old('panel_title', $strategicAdvisory->panel_title) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="panel_short_description" id="panel_short_description"
                                    ...
                                    rows="3"
                                    placeholder="Enter Panel Short Description">{{ old('panel_short_description', $strategicAdvisory->panel_short_description) }}</textarea>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="appointment_title" id="appointment_title"
                                    ...
                                    value="{{ old('appointment_title', $strategicAdvisory->appointment_title) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="appointment_short_description" id="appointment_short_description"
                                    ...
                                    rows="5"
                                    placeholder="Enter Appointment Short Description">{{ old('appointment_short_description', $strategicAdvisory->appointment_short_description) }}</textarea>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="conflict_title" id="conflict_title"
                                    ...
                                    value="{{ old('conflict_title', $strategicAdvisory->conflict_title) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="conflict_short_description" id="conflict_short_description"
                                    ...
                                    rows="5"
                                    placeholder="Enter Conflict Short Description">{{ old('conflict_short_description', $strategicAdvisory->conflict_short_description) }}</textarea>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="expression_title" id="expression_title"
                                    ...
                                    value="{{ old('expression_title', $strategicAdvisory->expression_title) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="expression_description" id="expression_description"
                                    ...
                                    rows="6"
                                    placeholder="Enter Expression Description">{{ old('expression_description', $strategicAdvisory->expression_description) }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($strategicAdvisory->content_file)
                                    <div class="mt-2 d-flex align-items-center gap-3">
                                        <a href="{{ asset($strategicAdvisory->content_file) }}" target="_blank" class="btn btn-sm btn-info text-white">
                                            <i class="fa-solid fa-file-code me-1"></i> View Current File ({{ basename($strategicAdvisory->content_file) }})
                                        </a>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="injected_status" id="injected_status">
                                    <option value="0" {{ old('injected_status', $strategicAdvisory->injected_status ?? 1) == 0 ? 'selected' : '' }}>Inactive</option>
                                    <option value="1" {{ old('injected_status', $strategicAdvisory->injected_status ?? 1) == 1 ? 'selected' : '' }}>Active</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card mb-5 bg-transparent border-0 shadow-none text-end">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="fa-solid fa-floppy-disk me-1"></i> Update Strategic Advisory
                    </button>
                </div>
            </form>
        </div>
