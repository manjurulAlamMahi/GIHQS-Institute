        ...
        <div class="col-lg-10">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit Membership Package — {{ $package->name }}</h4>
                ...
                <form action="{{ route('admin.membership-packages.update', $package->id) }}" method="POST">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa-solid fa-floppy-disk me-1"></i> Update Package
                        </button>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.repeater-features').repeater({
                show: function() {
                    $(this).slideDown();
                    // Clear textarea and all inputs in the cloned item
